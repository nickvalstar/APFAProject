...
import com.damirvandic.sparker.students.group6.LSH.Signature;
...
public class Vector implements Serializable {
    ...
    /**
     * Signature vector is stored here
     */
    ...
    /**
     * A product number, needed to perform clustering.
     */
    ...
    public Vector(int dimensions, String key) {
        this(key, new double[dimensions]);
    ...
    public double[] getSubset(Vector b) {

        double[] subset = new double[21];
        for (int j = 0; j < 20; j++) {
            subset[j] = this.values[j];
        }
        return subset;
    }
    ...
    /**
     * set pointer to associated ProductDesc object
     *
     * @param p
     */
    public void setProduct(ProductDesc p) {
        product = p;
    }
     ...
     * @throws ArrayIndexOutOfBoundsException when the two vectors do not have the same dimensions.
     */
    ...
    public void setWebshop(int number) {
        this.webshop = number;
    }
