 ...
 * DissimilarityMeasure<T> dissimilarityMeasure = ...;
 ...
 */
public final class HierarchicalAgglomerativeClusterer<T> {
    ...
    public HierarchicalAgglomerativeClusterer(final Experiment<T> experiment, final DissimilarityMeasure<T> dissimilarityMeasure, final AgglomerationMethod agglomerationMethod) {
    ...
    public void setExperiment(final Experiment<T> experiment) {
        this.experiment = experiment;
    }
    ...
    public void setDissimilarityMeasure(final DissimilarityMeasure<T> dissimilarityMeasure) {
        this.dissimilarityMeasure = dissimilarityMeasure;
    }
    ...
    private double[][] computeDissimilarityMatrix() {
        ...
        for (int o1 = 0; o1 < dissimilarityMatrix.length; o1++) {
            for (int o2 = 0; o2 < o1; o2++) {
                final double dissimilarity = dissimilarityMeasure.computeDissimilarity(experiment.getObservation(o1), experiment.getObservation(o2));
